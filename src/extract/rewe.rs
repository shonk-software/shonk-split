...
fn rewe_extract_positions_lines(text: &str) -> Vec<&str> {
...
pub fn extract_positions_from_rewe_text(text: &str) -> Vec<Position> {
    let position_lines = rewe_extract_positions_lines(text);
    rewe_extract_positions(position_lines)
}
